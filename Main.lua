...
-- Anti-cheat bypass (wait for character to load properly)
...
local SpeedSlider = CreateSlider(SpeedFrame, 16, 50, 100)
...
-- Feature functions
function CreateFeatureFrame(title, positionY)
...
function CreateSlider(parent, min, max, defaultValue)
